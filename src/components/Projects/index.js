  ...
  return (
      <div>
        <Project
          ...
          image={Readme}
          description="App dedicacted to creating a ReadMe for projects."
          repository="https://github.com/ItsMEChacon/ReadMe"
        />
        <Project
          name="Weather Dashboard"
          image={WeatherDashdboard}
          description="App dedicacted to returning weather forecast for the week"
        ...
        <Project
          name="Work Scheduler"
          image={WorkScheduler}
          description= "App dedicacted to creating a daily itinerary for work"
